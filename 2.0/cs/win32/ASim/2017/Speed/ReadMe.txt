Model:
	...
	Folder contents:
	    Speed_SWC.fmu                         FMU exported with ASim 2017
	    Speed_SWC_cc.bat                      Batch file to run FMU with FMUChecker
	    Speed_SWC_cc.csv                      Result file from simulation using FMUChecker with explicit Euler
	    Speed_SWC_cc.log					  Result log file from FMUChecker
	    Speed_SWC_ref.csv                     Result file from simulation using ASim 2017
